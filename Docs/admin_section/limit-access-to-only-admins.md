...
Luego en la carpeta `resources` luego en `views`, ingresamos a `posts`, creamos un archivo llamado `create.blade.php`
...
Seguidamente nos vamos al archivo `Kernel.php` y agregamos la siguiente linea de código en el atributo `$routeMiddleware`

```php
'admin' => MustBeAdministrator::class,
```

Ademas también llamamos al archivo anteriormente creado.

```php
use App\Http\Middleware\MustBeAdministrator;
```

Ahora nos vamos a `create.blade.php` y agregamos el siguiente código.
